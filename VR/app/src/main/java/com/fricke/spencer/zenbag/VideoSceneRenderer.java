 ...
 */
public class VideoSceneRenderer extends BaseVideoRenderer implements Renderer {
  ...
  private  BufferViewportList recommendedList;
  private  BufferViewportList viewportList;
  private  BufferViewport scratchViewport;
  ...
  private com.google.vr.ndk.base.Frame frame;
  private com.opentok.android.BaseVideoRenderer.Frame currentFrame;
  private ReentrantLock mFrameLock = new ReentrantLock();

  VideoSceneRenderer(Context context, Settings settings) {
...
//    surfaceView.setRenderer(mRenderer);
  ...
  public void setUpApi(GvrApi api) {
    this.api = api;
  ...
  public void startedPlaybackTrue() {
  ...
  public void startedPlaybackFalse() {
    hasFirstFrame = false;
    surfaceView.queueEvent(
      new Runnable() {
        @Override
  ...
  private void drawScene(GL10 gl, com.google.vr.ndk.base.Frame frame) {
